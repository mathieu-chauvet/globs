...
class DefaultFieldFactory {
    ...
    private static Class[] defaultValuesAnnotations =
            {DefaultInteger.class, DefaultBoolean.class, DefaultDouble.class,
...
//            return addLink(name, isKeyField, annotations);
    ...
    private static class DefaultIntegerField extends AbstractField implements IntegerField {
        private DefaultIntegerField(String name, GlobType globType,
            ...
            setDefaultValue(computeDefaultValue(this, annotations, DefaultIntegerAnnotationType.UNIQUE_KEY));
        }
...
//    }
    ...
    private static class DefaultLongField extends AbstractField implements LongField {
        private DefaultLongField(String name, GlobType globType,
            ...
            setDefaultValue(computeDefaultValue(this, annotations, DefaultLongAnnotationType.UNIQUE_KEY));
        }
    ...
    private static class DefaultDoubleField extends AbstractField implements DoubleField {
        ...
        public DefaultDoubleField(String name, GlobType globType,
            ...
            setDefaultValue(computeDefaultValue(this, annotations, DefaultDoubleAnnotationType.UNIQUE_KEY));
        }
    ...
    private static class DefaultBooleanField extends AbstractField implements BooleanField {
        public DefaultBooleanField(String name, GlobType globType, Annotations annotations) {
            super(name, globType, Boolean.class, annotations);
            setDefaultValue(computeDefaultValue(this, annotations, DefaultBooleanAnnotationType.UNIQUE_KEY));
        }
    ...
    private static class DefaultStringField extends AbstractField implements StringField {
        ...
        public DefaultStringField(String name, GlobType globType, Annotations annotations) {
            super(name, globType, String.class, annotations);
            Glob annotation = annotations.getAnnotation(MaxSizeType.KEY);
            if (annotation != null) {
                maxSize = annotation.get(MaxSizeType.VALUE);
            } else {
                maxSize = 255;
            }
            setDefaultValue(computeDefaultValue(this, annotations, DefaultStringAnnotationType.UNIQUE_KEY));
        }
    ...
    private static class DefaultDateField extends AbstractField implements DateField {
        public DefaultDateField(String name, GlobType globType, Annotations annotations) {
    ...
    private static class DefaultTimeStampField extends AbstractField implements TimeStampField {
        public DefaultTimeStampField(String name, GlobType globType, Annotations annotations) {
            super(name, globType, Date.class, annotations);
        }
    ...
    private static class DefaultBlobField extends AbstractField implements BlobField {
        ...
        public DefaultBlobField(String name, GlobType globType, Annotations annotations) {
            super(name, globType, byte[].class, annotations);
            if (annotations.hasAnnotation(MaxSizeType.KEY)) {
                MaxSize annotationSize = (MaxSize) annotations.getAnnotation(MaxSizeType.KEY);
    ...
    private static Object computeDefaultValue(Field field,
        ...
        Glob glob = annotations.getAnnotation(targetAnnotationClass);
        if (glob != null) {
