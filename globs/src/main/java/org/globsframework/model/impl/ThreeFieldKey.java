...
public class ThreeFieldKey extends DefaultKey {
   ...
   public boolean equals(Object o) {
      ...
      if (o.getClass() == ThreeFieldKey.class) {
         ...
         return
            otherSingleFieldKey.keyField1.getGlobType() == keyField1.getGlobType() &&
      ...
      Key otherKey = (Key)o;
      return keyField1.getGlobType() == otherKey.getGlobType()
             && Utils.equal(value1, otherKey.getValue(keyField1))
             && Utils.equal(value2, otherKey.getValue(keyField2))
             && Utils.equal(value3, otherKey.getValue(keyField3));
   }
