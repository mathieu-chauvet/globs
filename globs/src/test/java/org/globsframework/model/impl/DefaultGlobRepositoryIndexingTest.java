...
public class DefaultGlobRepositoryIndexingTest extends DefaultGlobRepositoryTestCase {
  ...
  public void testUniqueIndexWithDeleteCreate() throws Exception {
    ...
    Glob glob3 = repository.get(DefaultKey.create(DummyObjectIndex.TYPE, 4));
    Glob glob4 = repository.get(DefaultKey.create(DummyObjectIndex.TYPE, 3));
    ...
    localGlobRepository.create(DefaultKey.create(DummyObjectIndex.TYPE, 5),
    ...
    localGlobRepository.create(DefaultKey.create(DummyObjectIndex.TYPE, 1),
  ...
  private void delete(int id) {
    repository.delete(DefaultKey.create(DummyObjectIndex.TYPE, id));
  }

  private void change(int id, int value1, int value2, String name) {
    Key key = DefaultKey.create(DummyObjectIndex.TYPE, id);
